  ...
  return (
    <div id="report-content" className="animate-fade-in">
      ...
      {report?.caseTimeline && report.caseTimeline.length > 0 && (
        <Section title="Dòng thời gian Vụ việc (có thể sửa & sắp xếp)" id="caseTimeline" highlightTerm={highlightTerm} extraHeaderContent={timelineDownloadButton}>
            <p className="text-xs text-slate-500 mb-3 -mt-2">Kéo thả để sắp xếp. Di chuột qua sự kiện để hiện nút Sửa/Xóa.</p>
